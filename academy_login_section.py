...
@academy_signin.route("/authenticateUserCredentials/<string:username>/<string:password>")
@cross_origin(origin='*')
...
@academy_signin.route("/updatePassword/<string:username>/<string:password>", methods=['PUT'])
@cross_origin(origin='*')
